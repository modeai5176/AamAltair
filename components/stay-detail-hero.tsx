      ...
      <div className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute bottom-8 left-8 right-8">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-serif font-medium text-primary mb-4 text-balance">{title}</h1>
      ...
      <div className="sticky top-20 z-40 bg-card/90 backdrop-blur-sm border-b border-border p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Starting from KSh 15,000 per night</p>
          </div>
          <Button 
