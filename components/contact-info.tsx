    ...
    <div className="space-y-8 h-full flex flex-col">
      <div className="space-y-4">
        ...
        <p className="text-foreground/80 leading-relaxed">
          We're here to help you plan the perfect retreat experience. Whether
          you have questions about our accommodations, need help with travel
          arrangements, or want to discuss special requests, we're just a
          message away.
        </p>
      </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-foreground/80">
                  Fastest response for booking inquiries
                </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-foreground/80">
                  Detailed inquiries and booking requests
                </p>
                <p className="text-sm text-accent font-medium">
                  theaamaltair@gmail.com
                </p>
              </div>
              <Button
                variant="outline"
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-foreground/80">
                  Limited reception - WhatsApp preferred
                </p>
                <p className="text-sm text-accent font-medium">
                  +254 722 475 300
                </p>
