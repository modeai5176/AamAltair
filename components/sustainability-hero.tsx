      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center w-full">
        <div className="space-y-8">
          <div className="space-y-4">
            <p className="text-sm font-medium text-accent tracking-wide uppercase">Our Commitment</p>
          ...
          <p className="text-xl md:text-2xl text-foreground/90 leading-relaxed text-pretty max-w-3xl mx-auto">
            At Aam Altair, sustainability isn't just a practice—it's the foundation of everything we do. From renewable
            energy to local craftsmanship, we're committed to creating a positive impact on our environment and
            community.
          </p>
        </div>
      </div>
