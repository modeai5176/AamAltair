...
export function ContactForm() {
  ...
  return (
    <Card className="bg-card border-border h-full flex flex-col">
      <CardHeader>
        <CardTitle className="font-serif text-xl text-primary">Send us a Message</CardTitle>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
          ...
          {formData.inquiryType === "booking" && (
            <div className="space-y-4 p-4 bg-accent/5 rounded-lg border border-accent/20">
              <h3 className="font-serif text-lg font-semibold text-primary">Booking Details</h3>
          ...
          <div className="flex items-start space-x-3">
            ...
            />
            <Label htmlFor="newsletter" className="text-sm text-foreground leading-relaxed cursor-pointer">
              I'd like to receive updates about Aam Altair, including seasonal experiences, sustainability initiatives,
              and special offers.
            </Label>
          </div>
          ...
          <p className="text-xs text-muted-foreground text-center">
            We typically respond within 24 hours. For urgent inquiries, please use WhatsApp.
          </p>
        </form>
      </CardContent>
    </Card>
