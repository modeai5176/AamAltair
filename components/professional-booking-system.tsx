...
export function ProfessionalBookingSystem() {
  ...
  const getPropertyLabel = (code: string) => {
    if (code === "domestead") return "The Big Dipper";
    ...
    <Dialog>
      ...
      >
        <div className="flex flex-col h-full lg:h-auto">
          ...
          <div
            className="flex-1 lg:flex-none overflow-y-auto lg:overflow-visible px-4 pb-4 min-h-0"
            style={{
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            const minCheckoutString = minCheckout
                              .toISOString()
                              .split("T")[0];

                            if (
                              selectedDate &&
                              selectedDate < minCheckoutString
                            ) {
