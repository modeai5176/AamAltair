      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Partnership with Nature.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-foreground">River Galana, 150-acre orchard</p>
              <div className="flex space-x-4 pt-2">
                <a href="https://wa.me/254700000000" className="text-accent hover:text-primary transition-colors">
                  <MessageCircle size={20} />
                </a>
                <a href="mailto:hello@aamaltair.com" className="text-accent hover:text-primary transition-colors">
                  <Mail size={20} />
                </a>
                <a href="https://instagram.com/aamaltair" className="text-accent hover:text-primary transition-colors">
                  <Instagram size={20} />
                </a>
              </div>
            </div>
