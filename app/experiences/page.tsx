...
const experiences = [
  ...
  },
  {
    ...
    price: "Included",
    bookingRequired: true,
    image: "/nature-experiences-mango-orchard-kenya.avif",
  },
  {
    iconName: "Wine",
  ...
  {
    iconName: "TreePine",
    title: "Tsavo West / Tsavo East Self Drive",
    description: "Your gateway to raw, untouched wilderness.",
    longDescription:
      "There are plentiful Self Drive through the park - Tsavo East 1hour 35min away, Tsavo West 40min away ",
    duration: "1.5 hrs",
    bestTime: "Dry season",
    schedule: "5:30–7:00 PM",
    price: "Day Trip Nearby",
    bookingRequired: true,
