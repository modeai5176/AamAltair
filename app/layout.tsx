...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_BASE_URL || "https://aamaltair.com"
  ),
  ...
  openGraph: {
    title: "Aam Altair - Unplug. Unwind. Reconnect with Nature.",
    description:
      "A place where you wake up to mango orchards, the Milky Way, and the River Galana.",
    type: "website",
    locale: "en_US",
    siteName: "Aam Altair",
    images: [
      {
        url: "/aamaltair_logo.webp",
        width: 1200,
        height: 630,
